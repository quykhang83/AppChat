...
import com.mycompany.appChat.model.Channel;
...
public class ChannelDAO {
    ...
    public int getIDChannel(String username, String sender) throws Exception {
        ...
        int idChannel = -1;
        try (
                 Connection con = DB_Helper.openConnection();  PreparedStatement psmt = con.prepareStatement(sql);) {
        ...
        if (idChannel == -1) {
            ...
            try ( Connection con = DB_Helper.openConnection();  PreparedStatement psmt = con.prepareStatement(sql);) {
